 ...
 *
 */
/*CMZ :  2.04/15 14/03/94  01.32.15  by  Fons Rademakers*/
...
static void ClassInitialize ()
{
    XtAddConverter (XtRString, XtRGravity, XrdmCvtStringToGravity,
    ...
    Widget grequest, gnew;
{
    ...
    new->tree.tree_root = XtCreateWidget ("root", widgetClass, gnew, args,
                                          (Cardinal)2);
